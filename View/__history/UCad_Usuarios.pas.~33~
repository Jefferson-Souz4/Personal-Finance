...
begin
  ...
  Begin
    Try
    if Application.MessageBox('Atenção, Você não definiu nenhum valor para pesquisa, dependendo da quantidade de registros pode demorar alguns minutos!!', 'Atenção', MB_YESNO+MB_ICONQUESTION)= mrYes  then
    DM.CDS_tb_User.Close;
